...
Diabetes is frequently defined as an A1c value of 6.5 or greater (https://www.diabetes.org/a1c/diagnosis). Create a binary variable (0, 1) called `diabetic` indicating diabetes. Use the `ifelse` function. Use ?ifelse if you're  not sure how to use this function.
